...
catalog.workflow({name: "build", desc: "Build the package"}, function() {
  ...
  copy(
    "Create package",
    {
      ...
      dst: "dist/es5/nodejs/justo-generator-react/"
    },
    {
      src: "build/es5/lib/",
      dst: "dist/es5/nodejs/justo-generator-react/lib"
    },
    {
...
catalog.workflow({name: "publish", desc: "NPM publish."}, function() {
  publish("Publish in NPM", {
    who: "justojs",
    src: "dist/es5/nodejs/justo-generator-react"
  });
});

catalog.workflow({name: "install", desc: "Install the generator to test."}, function() {
  install("Install", {
    pkg: "dist/es5/nodejs/justo-generator-react/",
    global: true
  });
});
