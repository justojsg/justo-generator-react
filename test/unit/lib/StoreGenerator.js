...
const Generator = require("../../../dist/es5/nodejs/justo-generator-react")["store"];
...
suite("Generator", function() {
  ...
  suite("#generate()", function() {
    ...
    test("generate(answers)", function() {
      gen.generate({name: "MyStore"});
      file(DST, "app/stores/MyStore.js").must.exist();
      file(DST, "app/stores/MyStore.js").must.contain([
        "export default const store = new MyStore(dispatcher)",
